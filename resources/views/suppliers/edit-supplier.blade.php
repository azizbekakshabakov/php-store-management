...
<div class="container">
	...
	<form action="/table/suppliers/edit/{{$supplier->id}}" method="post">
		@csrf
		...
		<div class="form-group modal-body">
			...
			<input type="text" name="supply_date" class="form-control" value="{{$supplier->supply_date}}" id="supply-date-picker" placeholder="Pick a date">
		</div>
